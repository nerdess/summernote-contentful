...
const options = {
    ...
    callbacks: {
        ...
        //onChange:function(n,t){var o=$(this).summernote("code");e.field.setValue(o)},
        //onBlur:function(){var n=$(this).summernote("code");e.field.setValue(n)}
    },
    cleaner: {
    ...
    onInit: () => {console.log("Summernote is launched 123")},
    onChange: (n,t) => {const o=$(this).summernote("code");/*e.field.setValue(o)*/},
    onBlur: () => {const n=$(this).summernote("code");/*e.field.setValue(n)*/}
}
